...
const YOYAK_TARGETS: [RegExp, string][] = [
  ...
  [/초[·․.]?중[·․.]?고|초등학생|중학생|고등학생|고교생|학교\s*밖\s*청소년|대안교육기관|청소년쉼터|청소년증|위기청소년|아동[·․.]?청소년/, "초·중·고 학생"],
  // '출산전후휴가'(근로자 제도)까지 잡히지 않도록 출생·출산은 양육 맥락에서만 인정한다
  [/영유아|영아기?|신생아|미숙아|조산아?|출생\s*아동|출산\s*(?:가정|가구|가족|축하|장려|비용|및\s*양육)|산모|산후|임산부|임신부|어린이집|보육교직원|육아휴직|아이돌봄|장난감|양육수당/, "영유아·출산 가구"],
